...
- ✅ **♨️ Дулаан pool** — Next.js контейнерууд урьдчилан асаастай:
  preview үүсэх хугацаа 10–30 сек → **~1 секунд**. Хэмжээ: `WARM_POOL_SIZE`
  env (default 1). Controller асахдаа хуучин контейнеруудыг цэвэрлэдэг.
- ✅ Аюулгүй байдлын дүрмүүд суулгасан:
  - 🔒 root биш хэрэглэгч (`User: node`)
  - 🔒 512MB/1GB RAM, CPU, 256 process хязгаар
  - 🔒 15 мин дараа **автоматаар устана** (ephemeral)
  - 🔒 Файлын зам шалгана (`..` хориглоно, path traversal хамгаалалт)
  - 🔒 **Тусгаарлагдсан сүлжээ** (`kodu-sandbox-net`, icc=false) —
    контейнерууд хоорондоо ярьж чадахгүй (ping 100% loss, туршигдсан)
...
| Хүсэлт | Үүрэг |
|--------|-------|
| `POST /api/previews` | `{ files: [{path, content}, ...], mode: "static"\|"app", ttlMin? }` → контейнер асаана, `{id, url}` буцаана. (`{html: "..."}` хуучин хэлбэрийг ч дэмжинэ) |
| `GET /api/previews` | Ажиллаж буй preview-уудын жагсаалт |
| `POST /api/previews/:id/keepalive` | ⏱️ Preview-ийн устах цагийг хойшлуулна (ашиглаж байвал амьд байлга). `{ ttlMin? }` |
| `DELETE /api/previews/:id` | Preview зогсоож устгана |

### ⏱️ TTL (амьдрах хугацаа) ба keepalive

- Preview нь **идэвхгүй** байх `TTL` (default **15 мин**) дараа өөрөө устана.
- **keepalive** дуудвал цаг **0-оос дахин** тоолж эхэлнэ → ашиглаж байгаа preview
  унтрахгүй, орхивол л устана (E2B-ийн загвар).
- Тохируулга: `KODU_TTL_MIN` env (бутархай минут болно, жишээ `0.5`),
  эсвэл хүсэлт бүрт `ttlMin`. Аюулгүйн дээд хязгаар: **8 цаг**.
- KoDu-гийн preview iframe үүнийг ~5 мин тутам дуудаж, нээлттэй байх цагт амьд байлгана.
